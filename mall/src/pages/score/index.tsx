...
export default function Score() {
  const headnav = [
    { tabName: '比分', id: 0, path: 'scoreList/score', name: 'bife' },
    { tabName: '完场', id: 1, path: 'scoreList/wanchang', name: 'wanchang' },
    { tabName: '赛程', id: 2, path: 'scoreList/saichen', name: 'saichen' },
    // { tabName: '完整', id: 3, path: 'scoreList/wanzheng', name: 'wanzheng' }
  ]
  ...
  if (headnavIndex === 0) {
    navRight = <Bifen />
  } else if (headnavIndex === 1) {
    navRight = (<WanChang />)
  } else if (headnavIndex === 2) {
    navRight = (<WanChang />)
  } else if (headnavIndex === 3) {
    navRight = (<div></div>)
  }

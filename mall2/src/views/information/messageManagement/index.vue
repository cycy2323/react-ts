  ...
  <div class="container">
    <main class="main">
      ...
      <div class="film_content">
        ...
        <!--分页组件-->
        <pagination :pages="pages" :fetchData="() => getMessageList()" />
      </div>
    </main>
    <div />

    <!-- 发布消息 -->
    <release-msg :show="isRelease" :optionsList="platformOption"></release-msg>
  </div>
</template>
<script>
import { publishMessage, messageDelete, messageList } from "@/api/message_api";

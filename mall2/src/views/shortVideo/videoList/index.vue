<template>
  <div class="container">
    <main class="main">
      ...
      <div class="film_content">
        ...
        >
          ...
          <el-table-column label="时长" align="center" prop="videoTime" />
          <el-table-column label="大小" prop="videoSize" align="center" />
          <el-table-column label="用户昵称" prop="author" align="center" />
          <el-table-column
            label="平均播放时长"
            prop="averagePlay"
            align="center"
          ...
          >
            <template slot-scope="scope">
              <el-button class="btn_change_handle" size="mini" type="primary"
                >编辑</el-button
              >
              <el-button
        ...
        <!--分页组件-->
        <pagination :pages="pages" :fetchData="() => fetchFilmData()" />
      </div>
    </main>
    <div />
    <!-- 查看视频 -->
    ...
    <!-- 上传 -->
    <upload :show="isUpload" :nickIdOptions="nickIdOptions"></upload>
    <!-- 视频详情 -->
...
export default {
  ...
  methods: {
    ...
    handleSearch() {
      ...
      this.fetchFilmData(this.filmForm);
    },
    // 重置
    handleReset() {
      this.uploadDate = [];
